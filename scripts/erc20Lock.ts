...
const errors = async (): Promise<void> => {
    ...
    await handleContractFunction(contract, 'lockAmount', deployer, null, 100, 987654321)
    await handleContractFunction(contract, 'lockAmount', account1, null, 100, 34014895)
